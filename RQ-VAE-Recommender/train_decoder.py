...
from evaluate.recdata_eval import evaluate_recdata
...
def train(
    ...
    model = EncoderDecoderRetrievalModel(
        ...
        user_num_buckets=(
            getattr(train_dataset._recdata, "n_users", 2000)
            if user_num_buckets <= 0 else user_num_buckets
        ),
